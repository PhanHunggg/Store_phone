import { Controller, Get, Post, Body, Patch, Param, Delete, Put, HttpException, InternalServerErrorException, Res } from '@nestjs/common';
...
export class BrandController {
  ...
  @Post("/create-brand")
  async createBrand(@Res() res: Response, @Body() body: CreateBrandDTO): Promise<Response> {
    try {
  ...
  async updateBrand(@Param('id_brand') id_brand: string, @Res() res: Response, @Body() body: CreateBrandDTO): Promise<Response> {
    try {
