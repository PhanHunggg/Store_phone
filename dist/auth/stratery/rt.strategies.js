...
let RtStrategy = class RtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'jwt-rt') {
    constructor(config) {
        super({
    ...
    validate(req, payload) {
        var _a;
        const refreshToken = (_a = req === null || req === void 0 ? void 0 : req.get('refreshToken')) === null || _a === void 0 ? void 0 : _a.replace('Bearer', '').trim();
        if (!refreshToken)
